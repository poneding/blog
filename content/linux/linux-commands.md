[🏠 首页](../_index.md) / [Linux](_index.md) / Linux 命令
...
![alt text](https://images.poneding.com/2025/03/202503112119852.png)
...
![alt text](https://images.poneding.com/2025/03/202503112119315.png)

**否定参数，可以用 ！排除所指定到的模式**：

![alt text](https://images.poneding.com/2025/03/202503112119672.png)
...
![alt text](https://images.poneding.com/2025/03/202503112120517.png)

例如-maxdepth的参数为1时，只匹配当前目录下。

![alt text](https://images.poneding.com/2025/03/202503111824171.png)
...
![alt text](https://images.poneding.com/2025/03/202503111824383.png)
...
![alt text](https://images.poneding.com/2025/03/202503111824054.png)

此处的文件是我在进行截图之前才创建的，访问，修改，变化时间均小于一天。

当然相应的用分钟作为单位就可以用选项 (-amin）(-mmin)(-cmin)，如下我们测试修改时间

![alt text](https://images.poneding.com/2025/03/202503111824968.png)
...
![alt text](https://images.poneding.com/2025/03/202503111825456.png)

信息的第五列就是各文件目录的大小（字节），我们通过指定匹配条件来搜索：

![alt text](https://images.poneding.com/2025/03/202503111825825.png)
...
![alt text](https://images.poneding.com/2025/03/202503111825040.png)
...
![alt text](https://images.poneding.com/2025/03/202503111825034.png)
...
![alt text](https://images.poneding.com/2025/03/202503111825157.png)

**指定 find 跳过特定的目录**：

使用 -prune 选项可以跳过我们在搜寻的的一些明显我们不需要的目录

![alt text](https://images.poneding.com/2025/03/202503111825429.png)
